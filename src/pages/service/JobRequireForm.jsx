...
const JobRequireForm = () => {
  ...
  const jobRequireMutation = useMutation({
    mutationFn: (payload) => {
      return axios.post(`${BASE_URL}/api/create-job-required`, payload, {
    ...
    onError: (error) => {
      ...
      toast.error(
        error.response?.data?.message || "Failed to submit job application"
      );
      setLoader(false);
    },
  });
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center">
                      ...
                      <label
                        ...
                        className="ml-2 sm:ml-3 block text-xs sm:text-sm text-gray-700"
                      >
              ...
              <div className="pt-4 sm:pt-6 border-t border-gray-200 space-y-3 sm:space-y-4">
                ...
                <div>
                  <label
                    ...
                    className="block text-sm font-medium text-gray-700 mb-1"
                  >
                    Have you lost any person in this pandemic – Relationship
                    with the deceased
                  </label>
                  <textarea
                    id="person"
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  ...
                  <div className="md:w-2/5 mt-4 md:mt-0 md:pl-4">
                    {!showCaptcha && (
                      <motion.button
                        onClick={handleNext}
                        className="w-full  flex justify-center py-1.5 sm:py-2.5 px-3.5 sm:px-5.5 border border-transparent rounded-md shadow-sm text-xs sm:text-sm font-medium text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
              ...
              {showCaptcha && (
                <div className="  ">
                  <motion.button
                    ...
                    className="w-full flex justify-center py-2 sm:py-3 px-4 sm:px-6 border border-transparent rounded-md shadow-sm text-xs sm:text-sm font-medium text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                  >
