                ...
                <div className="flex flex-col lg:flex-row  gap-6 lg:gap-8">
                  ...
                  <div className="w-full lg:w-[60%] xl:w-[65%] relative mt-8 sm:mt-12 lg:mt-0 p-1 sm:p-2">
                    ...
                    <div className="flex  flex-col md:flex-row items-center gap-2 mt-4 sm:mt-4 lg:mt-6">
                      {/* payment mediation  */}
                      <div
                        className="group relative flex flex-col justify-between overflow-hidden bg-white [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] transform-gpu rounded-lg p-3 sm:p-5 w-full md:max-w-md mx-auto h-full"
                        style={{
                      ...
                      >
                        ...
                        <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 md:min-h-[7rem] transition-all duration-300">
