...
const BecomeMember = () => {
  ...
  const membershipData = {
    "life-patron": {
      ...
      price: "₹20,000",
      priceNote: "+ GST",
      description: "Lifetime subscription with premium benefits and exclusive access",
                ...
                <>
                  ...
                  >
                    {Object.entries(membershipData).map(([key, data]) => (
                      ...
                      >
                        <div className={`relative p-6 border-2 rounded-2xl transition-all duration-300 h-full ${
                          ...
                          {/* Pattern Background */}
                          {membershipCategory === key && (
                            <div className={`absolute inset-0 ${data.textColor}`}>
                          ...
                          <div className="relative flex flex-col h-full">
                            <div className="flex items-start justify-between mb-3">
                                ...
                                <div>
                                  ...
                                  <div className="flex items-baseline gap-1 mt-1">
                                    <span className={`text-2xl font-bold ${
                                      membershipCategory === key ? data.textColor : 'text-gray-900'
                                    }`}>
                                      {data.price}
                                    </span>
                              ...
                              {membershipCategory === key && (
                                <div className={`p-2 rounded-full ${data.accentColor} text-white`}>
        ...
        <span className="ml-2 text-xs font-normal opacity-80">
          • {membershipData[membershipCategory]?.price}
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <Label className="text-gray-900">Authorized Representative Name *</Label>
                        <Input className="mt-2 bg-white/50 backdrop-blur-sm border-gray-300 hover:border-gray-400 focus:ring-2 focus:ring-indigo-200" />
                      </div>
