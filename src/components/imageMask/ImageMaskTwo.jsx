...
const ImageMaskTwo = React.forwardRef(({ className, ...props }, ref) => (
  <div ref={ref} className={className} {...props}>
    ...
    <section className='grid grid-cols-3 gap-8  bg-transparent   rotate-90 rounded-lg p-5'>
      <figure style={{ clipPath: 'url(#clip-pattern)' }} className='rotate-270'>
        {/* <img
      ...
      <figure style={{ clipPath: 'url(#clip-pattern1)' }} className='rotate-270'>
        {/* <img
   ...
   className='transition-all duration-300  aspect-[4/5] min-h-full   align-bottom object-cover  hover:scale-110 w-full'
     />
      ...
      <figure style={{ clipPath: 'url(#clip-pattern2)' }} className='rotate-270'>
        {/* <img
   ...
   className='transition-all duration-300  aspect-[4/5] min-h-full  align-bottom object-cover  hover:scale-110 w-full'
     />
      ...
      <figure style={{ clipPath: 'url(#clip-pattern3)' }} className='rotate-270'>
        {/* <img
   ...
   className='transition-all duration-300 aspect-[4/5] min-h-full  align-bottom object-cover  hover:scale-110 w-full'
     />
      ...
      <figure style={{ clipPath: 'url(#clip-pattern4)' }} className='rotate-270'>
        {/* <img
   ...
   className='transition-all duration-300  aspect-[4/5] min-h-full   align-bottom object-cover  hover:scale-110 w-full'
     />
      ...
      <figure style={{ clipPath: 'url(#clip-pattern5)' }} className='rotate-270'>
        {/* <img
   ...
   className='transition-all duration-300 aspect-[4/5] min-h-full  align-bottom object-cover  hover:scale-110 w-full'
     />
      ...
      <figure style={{ clipPath: 'url(#clip-pattern6)' }} className='rotate-270'>
        {/* <img
   ...
   className='transition-all duration-300  aspect-[4/5] min-h-full  align-bottom object-cover  hover:scale-110 w-full'
     />
      ...
      <figure style={{ clipPath: 'url(#clip-pattern7)' }} className='rotate-270'>
        {/* <img
   ...
   src='https://images.unsplash.com/photo-1718633739487-6efee8ac466d?w=500&auto=format&fit=crop'
     ...
     />
      ...
      <figure style={{ clipPath: 'url(#clip-pattern8)' }} className='rotate-270'>
        {/* <img
...
ImageMaskTwo.displayName = 'ImageMaskTwo';

export default ImageMaskTwo;
