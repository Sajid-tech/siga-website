...
const testimonials = [
  {
    title: "Meeting with Honorable Prime Minister Narendra Modi",
      ...
      <div className="relative z-10 max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {stats.map((stat, index) => (
            <div key={index} className="text-center p-4 sm:p-6 bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl shadow-sm">
        ...
        >
          ...
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-indigo-400/10 via-transparent to-purple-500/15"></div>
            <div className="absolute top-1/4 left-1/4 w-8 sm:w-16 h-8 sm:h-16 rounded-full bg-indigo-400/10 blur-lg sm:blur-xl"></div>
            <div className="absolute bottom-1/3 right-1/3 w-12 sm:w-24 h-12 sm:h-24 rounded-full bg-purple-500/15 blur-lg sm:blur-xl"></div>
          </div>
          ...
          <div className="relative z-10">
            ...
            <button onClick={()=>navigate('/become-member')} className="px-6 py-3 hover:cursor-pointer  bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-medium transition-colors duration-300">
              Get Involved
            </button>
          </div>
        </motion.div>
